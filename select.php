...
<div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="name"  id="name" class="form-control" placeholder="Enter your name" value="<?=$key['name'];?>">
                </div>
        

                <div class="col-md-6">
                    <label for="contact">Contact</label>
                    <input type="text" name="contact"  id="name" placeholder="Enter your mobile number " class="form-control" value="<?=$key['contact'];?>">
                </div>
            ...
            <div class="row">
                 ...
                 <div class="col-md-6">
                    ...
                    <select name="product" id="product" class="form-control" value="product">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="email"  id="name" placeholder="Enter your Email " class="form-control" value="<?=$key['email'];?>">
                </div>
            ...
            <div class="col-md-12">
                    ...
                    <input type="text" name="message" id="message"  placeholder="your message write here..." class="form-control" value="<?=$key['message'];?>" >
